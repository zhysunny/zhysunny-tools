...
public class XmlToJsonTest {
    ...
    public void testRead1() throws Exception {
        mapping = new XmlReader(classLoader.getResource("example/xml/1/xml_to_xml.xml")).read(Mapping.class);
    ...
    public void testRead2() throws Exception {
        mapping = new XmlReader(classLoader.getResource("example/xml/2/xml_to_xml.xml")).read(Mapping.class);
        List<JSONObject> datas = (List<JSONObject>)new XmlReader(classLoader.getResource("example/xml/2/input.xml"))
        .read(new XmlToJson(mapping));
        System.out.println(datas);
